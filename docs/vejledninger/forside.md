...
<br>
<details>
  <summary><strong>Trin 1: Administration af forside af den eksterne hjemmeside</strong></summary>
  <p>Fra forsiden af den administrative hjemmeside skal du:</p>
  <ol>
    <li>Vælge Administration i topmenuen</li>
    <li>Klikke på Ekstern hjemmeside</li>
    <li>Klikke på forside</li>
  </ol>
  <img src="../images/img_vejledninger/forside-aministration.png" alt="Administration af forside">
</details><br>

<details>
  <summary><strong>Trin 2: Redigering af indhold</strong></summary>
  <ol>
