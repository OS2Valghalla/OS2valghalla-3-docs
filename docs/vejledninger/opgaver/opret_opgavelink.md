...
<details>
  ...
  <img src="../../images/img_opgaver/opgaver-opret-opgavelink.PNG" alt="Opgaver - Opret opgavelink">
</details><br>

<details>
  <summary><strong>Trin 2: Konfigurer dit link</strong></summary>
  <p>Du konfigurerer det link, du skal bruge, ved at benytte de forskellige drop-down menuer.</p>
  <p>Der er seks kolonner / parametre, som du kan bruge til at konfigurere dit link:</p>
  <ol>
  ...
  <p>Efterhånden som du justerer de forskellige parametre, vil billedet vise, hvilket resultat modtagerne vil se.</p>
  <p>Når du har konfigureret linket, kan du kopiere linket til højre for filteret.</p>
  <p>Det er også muligt at kopiere et direkte link til den enkelte opgave, såfremt modtageren kun skal kunne se denne ene opgave.</p>
  <img src="../../images/img_opgaver/opgaver-opret-opgavelink-konfig.png" alt="Opgaver - Opret opgavelink - konfigurering">
</details>